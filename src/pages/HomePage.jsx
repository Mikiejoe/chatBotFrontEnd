...
const Messages = [
  {
    role: "system",
    content:
      "You areDr. Rachel, my psychologist.Let's keep the conversation human-like, responding in a way that feels natural and relatable. Send emojis where necessary.",
  },
];
const testData = [
  {
  ...
  return (
    <div className="h-[100vh] w-[100vw] overflow-x-hidden bg-gray-100">
      <div className="h-14 px-4 py-2 flex items-center gap-2 shadow-lg bg-gray-400">
        ...
        <div>
          <p className="font-bold">Itakua Fty</p>
